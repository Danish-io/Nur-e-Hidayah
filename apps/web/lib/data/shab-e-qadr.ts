...
export const SHAB_E_QADR_NAMAZ: ShabEQadrNamaz[] = [
    {
        ...
        rakats: "2 Rakat Nafl",
        method: [
            "In every Rakat after Surah Fatiha read Surah Ikhlas 7 times.",
    ...
    },
    {
        ...
        method: [
            "In every Rakat after Surah Fatiha read Surah Takathur 1 time.",
            "Then read Surah Ikhlas 3 times."
        ],
    ...
    },
    {
        ...
        rakats: "4 Rakat Nafl (2 salams of 2 rakats)",
        method: [
            "In every Rakat after Surah Fatiha read Surah Qadr 3 times.",
            "Then read Surah Ikhlas 50 times."
        ],

...
export default async function HadithBook({
    params,
    searchParams
}: {
    params: { slug: string },
    ...
    const { hadiths, total, totalPages } = await getHadiths(params.slug, page, 20, lang);
            ...
            <div className="space-y-6 max-w-4xl mx-auto">
                ...
                {totalPages > 1 && (
                    <div className="flex items-center justify-center gap-4 py-8">
                        <Link href={`/hadith/${params.slug}?page=${Math.max(1, page - 1)}&lang=${lang}`}>
                        ...
                        <Link href={`/hadith/${params.slug}?page=${Math.min(totalPages, page + 1)}&lang=${lang}`}>

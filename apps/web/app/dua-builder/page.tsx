...
export default function DuaBuilderPage() {
  ...
  const handleCopy = () => {
    if (result) {
      navigator.clipboard.writeText(result.guidedDua);
      setCopied(true);
          ...
          >
            ...
            <div className="bg-[#1C1C1C] rounded-2xl p-6 md:p-8 border border-emerald-500/20 shadow-[0_0_30px_rgba(16,185,129,0.05)]">
              ...
              <div className="bg-[#161616] rounded-xl p-6 border border-white/5 mb-6">
                <h3 className="text-emerald-400 text-sm font-bold uppercase tracking-wider mb-4">Your Personal Dua</h3>
            ...
            <div className="bg-[#1C1C1C] rounded-2xl p-6 md:p-8 border border-white/5 shadow-xl">
              <h2 className="text-xl font-bold text-white tracking-tight mb-2">Authentic source duas and adhkar</h2>
              <p className="text-sm text-slate-400 mb-6">These are the sourced supplications and remembrances that best fit your request.</p>
          ...
          <div className="bg-[#1C1C1C] rounded-2xl p-6 md:p-8 border border-white/5 shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="text-sm text-slate-300">Use the guided personal dua, then recite the authentic sources below.</p>
              </div>
            </div>
          </div>
        )}

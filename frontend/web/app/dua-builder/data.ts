...
export interface GeneratedData {
  guidedDua: string;
  guidedDuaUrdu?: string;
  guidedDuaRomanUrdu?: string;
...
export const dataLookup: Record<IntentId, GeneratedData> = {
  ease: {
    ...
    guidedDuaRomanUrdu: "Ya Allah, Ar-Rahman, Tu nihayat meherban hai. Main apni takleef ki ghari mein Teri taraf ruju karta hoon. Mere dil par mali dabao ka jo bojh hai Tu usay dekh raha hai, aur main Teri rahmat, Ar-Raheem ka talabgar hoon. Mujhe halal rizq aur asani ata farma, aur barakah ke darwaze khol de. Mere dil ko sukoon ata farma aur apni hidayat mein mujhe rahat de. Mujhe apni tadbeer par tawakkul karne ki taufiq de. Ya Allah, mera har kaam Tere liye ho aur meri rozi shukr guzari ka zariya bane. Ameen.",
    namesOfAllah: [
      {
